    ...
    return (
        <section className="mentions-legales">
            ...
            <p>
                ...
                Orchestra , ci-après le "Site", les présentes mentions légales.
            </p>
            <p>
            ...
            <h2 className="articles">EDITION DU SITE</h2>

            <p>
                L'édition du Site est assurée par la société MYLi, SAS au capital de 2000000000 euros, immatriculée
                au Registre du Commerce et des Sociétés de Peros-Guirec sous le numéro 157389243 dont le siège
                social est situé au 11 rue de la gare,
                - Numéro de téléphone : 0123456789
                - Adresse e-mail : mylimusique@gmail.com.
                - N° de TVA intracommunautaire : FR52157389243
                - Directeur de la publication : Jean Directeur
            </p>

            <h2 className="articles">HEBERGEUR</h2>

            <p>
                L'hébergeur du Site est la société MuSE, dont le siège social est situé au 20 rue de la Gare 22300
                Lannion . 
            </p>

            <h2 className="articles">ACCES AU SITE</h2>
            ...
            <h2 className="articles">COLLECTE DES DONNEES</h2>
